...
exports.COA_MAP = exports.COA_ACCOUNTS = void 0;
exports.getBySchedule = getBySchedule;
exports.getByType = getByType;
exports.COA_ACCOUNTS = [
    // ──────────────────────────────────────────────────────────
...
exports.COA_MAP = new Map(exports.COA_ACCOUNTS.map((a) => [a.code, a]));
/** Return all accounts filtered by schedule */
function getBySchedule(schedule) {
    return exports.COA_ACCOUNTS.filter((a) => a.schedule === schedule);
}
/** Return all accounts filtered by type */
function getByType(type) {
    return exports.COA_ACCOUNTS.filter((a) => a.type === type);
}
//# sourceMappingURL=coa-constants.js.map