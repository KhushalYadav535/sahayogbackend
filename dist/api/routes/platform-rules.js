...
const ruleSchema = zod_1.z.object({
    ...
    category: zod_1.z.enum(["AML", "CREDIT", "COMPLIANCE", "OPERATIONAL"]),
    condition: zod_1.z.string().min(1),
    action: zod_1.z.enum(["BLOCK", "FLAG", "NOTIFY", "APPROVE_REQUIRED"]),
    enabled: zod_1.z.boolean(),
    priority: zod_1.z.number().min(1).max(5),
    lastTriggered: zod_1.z.string().optional(),
    triggerCount: zod_1.z.number().optional(),
    tenantOverridable: zod_1.z.boolean(),
});
const DEFAULT_RULES = [
