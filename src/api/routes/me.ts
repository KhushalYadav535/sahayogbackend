...
router.get("/profile", memberAuthMiddleware, async (req: MemberAuthRequest, res: Response): Promise<void> => {
    try {
...
router.get("/products", memberAuthMiddleware, async (req: MemberAuthRequest, res: Response): Promise<void> => {
    try {
